...
export interface IHelpArticlesPersistence
    extends IGetter<HelpArticleV1, string>, IWriter<HelpArticleV1, string>  {
    ...
    create(correlationId: string, item: HelpArticleV1,
        callback: (err: any, item: HelpArticleV1) => void): void;

    update(correlationId: string, item: HelpArticleV1,
        callback: (err: any, item: HelpArticleV1) => void): void;
