# Configuration Help <br/> Help Microservice

User help microservice configuration structure follows the 
...
[Pip.Services Configuration Help](https://github.com/pip-services/pip-services3-container-node/doc/Configuration.md#persistence)
...
Example:
```yaml
- descriptor: "pip-services-help:persistence:memory:default:1.0"
  options:
    max_page_size: 100
```
...
For more information on this section read 
[Pip.Services Configuration Help](https://github.com/pip-services/pip-services3-container-node/doc/Configuration.md#deps)
