# Deployment Help <br/> Help Microservice

Help microservice can be used in different deployment scenarios.
...
See [Configuration Help](Configuration.md) for details.
...
The Help microservice can also be used as a Seneca plugin.
...
var plugin = require('pip-services-help-node').HelpSenecaPlugin;
...
or by using [HelpSenecaClient](https://github.com/pip-services/pip-clients-help-node/NodeClientApiV1.md/#client_seneca)