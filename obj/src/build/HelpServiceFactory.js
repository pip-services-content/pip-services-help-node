...
class HelpServiceFactory extends pip_services_components_node_1.Factory {
    constructor() {
        super();
...
HelpServiceFactory.Descriptor = new pip_services_commons_node_1.Descriptor("pip-services-help", "factory", "default", "default", "1.0");
HelpServiceFactory.TopicsMemoryPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-help", "persistence-topics", "memory", "*", "1.0");
HelpServiceFactory.TopicsFilePersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-help", "persistence-topics", "file", "*", "1.0");
HelpServiceFactory.TopicsMongoDbPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-help", "persistence-topics", "mongodb", "*", "1.0");
HelpServiceFactory.ArticlesMemoryPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-help", "persistence-articles", "memory", "*", "1.0");
HelpServiceFactory.ArticlesFilePersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-help", "persistence-articles", "file", "*", "1.0");
HelpServiceFactory.ArticlesMongoDbPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-help", "persistence-articles", "mongodb", "*", "1.0");
HelpServiceFactory.ControllerDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-help", "controller", "default", "*", "1.0");
HelpServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-help", "service", "http", "*", "1.0");
