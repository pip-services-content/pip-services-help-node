...
class HelpCommandSet extends pip_services3_commons_node_1.CommandSet {
    constructor(logic) {
        super();
        this._logic = logic;
    ...
    makeGetTopicsCommand() {
        return new pip_services3_commons_node_2.Command("get_topics", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeGetTopicByIdCommand() {
        return new pip_services3_commons_node_2.Command("get_topic_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('topic_id', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
    ...
    makeCreateTopicCommand() {
        return new pip_services3_commons_node_2.Command("create_topic", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeUpdateTopicCommand() {
        return new pip_services3_commons_node_2.Command("update_topic", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('topic', new HelpTopicV1Schema_1.HelpTopicV1Schema()), (correlationId, args, callback) => {
            let topic = args.get("topic");
    ...
    makeDeleteTopicByIdCommand() {
        return new pip_services3_commons_node_2.Command("delete_topic_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('topic_id', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
            let topicId = args.getAsNullableString("topic_id");
    ...
    makeGetArticlesCommand() {
        return new pip_services3_commons_node_2.Command("get_articles", new pip_services3_commons_node_5.ObjectSchema(true)
            .withOptionalProperty('filter', new pip_services3_commons_node_7.FilterParamsSchema())
            .withOptionalProperty('paging', new pip_services3_commons_node_8.PagingParamsSchema()), (correlationId, args, callback) => {
            let filter = pip_services3_commons_node_3.FilterParams.fromValue(args.get("filter"));
            let paging = pip_services3_commons_node_4.PagingParams.fromValue(args.get("paging"));
    ...
    makeGetRandomArticleCommand() {
        return new pip_services3_commons_node_2.Command("get_random_article", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeGetArticleByIdCommand() {
        return new pip_services3_commons_node_2.Command("get_article_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('article_id', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
    ...
    makeCreateArticleCommand() {
        return new pip_services3_commons_node_2.Command("create_article", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeUpdateArticleCommand() {
        return new pip_services3_commons_node_2.Command("update_article", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('article', new HelpArticleV1Schema_1.HelpArticleV1Schema()), (correlationId, args, callback) => {
            let article = args.get("article");
    ...
    makeDeleteArticleByIdCommand() {
        return new pip_services3_commons_node_2.Command("delete_article_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('article_id', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
            let articleId = args.getAsNullableString("article_id");
