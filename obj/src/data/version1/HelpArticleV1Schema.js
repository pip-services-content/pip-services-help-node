...
class HelpArticleV1Schema extends pip_services3_commons_node_1.ObjectSchema {
    constructor() {
        super();
        /* Identification */
        this.withOptionalProperty('id', pip_services3_commons_node_2.TypeCode.String);
        this.withOptionalProperty('topic_id', pip_services3_commons_node_2.TypeCode.String);
        ...
        /* Search */
        this.withOptionalProperty('tags', new pip_services3_commons_node_3.ArraySchema(pip_services3_commons_node_2.TypeCode.String));
        this.withOptionalProperty('all_tags', new pip_services3_commons_node_3.ArraySchema(pip_services3_commons_node_2.TypeCode.String));
        /* Content */
        this.withOptionalProperty('content', new pip_services3_commons_node_3.ArraySchema(new HelpArticleContentV1Schema_1.HelpArticleContentV1Schema()));
        /* Status */
